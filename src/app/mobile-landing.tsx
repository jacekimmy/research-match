  ...
  return (
    <div style={{ minHeight: "100vh", position: "relative", overflowX: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "100%", pointerEvents: "none", zIndex: -1, overflow: "hidden", maxWidth: "100vw" }}>
        <div ref={(el) => { splotchRefs.current[0] = el; }} style={{ position: "absolute", top: "5%", right: "-10%", width: 160, height: 160, borderRadius: "50%", background: "radial-gradient(ellipse at 35% 40%, rgba(61,122,106,0.35) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
        <div ref={(el) => { splotchRefs.current[1] = el; }} style={{ position: "absolute", top: "25%", left: "-5%", width: 180, height: 180, borderRadius: "50%", background: "radial-gradient(ellipse at 60% 30%, rgba(168,196,188,0.5) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
        <div ref={(el) => { splotchRefs.current[2] = el; }} style={{ position: "absolute", top: "45%", right: "5%", width: 140, height: 140, borderRadius: "50%", background: "radial-gradient(ellipse at 40% 60%, rgba(184,216,206,0.45) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
        <div ref={(el) => { splotchRefs.current[3] = el; }} style={{ position: "absolute", top: "60%", left: "10%", width: 200, height: 200, borderRadius: "50%", background: "radial-gradient(ellipse at 50% 50%, rgba(20,70,60,0.2) 0%, transparent 70%)", filter: "blur(60px)", willChange: "transform" }} />
        <div ref={(el) => { splotchRefs.current[4] = el; }} style={{ position: "absolute", top: "78%", right: "15%", width: 150, height: 150, borderRadius: "50%", background: "radial-gradient(ellipse at 55% 40%, rgba(26,107,90,0.25) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
        <div ref={(el) => { splotchRefs.current[5] = el; }} style={{ position: "absolute", top: "92%", left: "30%", width: 180, height: 180, borderRadius: "50%", background: "radial-gradient(ellipse at 45% 55%, rgba(90,160,140,0.28) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
      </div>
      ...
      <nav style={{
        ...
        <span style={{ fontSize: "1.1rem", fontWeight: 800, color: "#1A6B5A", letterSpacing: "-0.02em", whiteSpace: "nowrap" }}>
          Research Match
        </span>
        <Link href="/app" style={{
      ...
      <section style={{ padding: "24px 20px 40px", textAlign: "center" }}>
        <h1 style={{
          ...
          color: "#1A6B5A", lineHeight: 1.12, marginBottom: "20px",
        ...
        <p style={{
          fontSize: "0.9rem", color: "#7A8E88", fontStyle: "italic", marginBottom: "12px",
        }}>
      ...
      <section style={{ padding: "40px 20px 50px" }}>
        ...
        <div style={{
          ...
          background: "linear-gradient(90deg, transparent, #A8C4BC, transparent)",
          borderRadius: 2,
        }} />
            ...
            >
              ...
              {i < steps.length - 1 && (
                <div className="mobile-timeline-line" style={{
                  ...
                  bottom: "0",
                  width: "2px",
                  background: "linear-gradient(to bottom, #A8C4BC, rgba(168,196,188,0.2))",
                }} />
              )}
              {/* Step circle */}
              <div style={{
                ...
                fontWeight: 700,
                color: "#F5F0E6",
                boxShadow: "0 2px 8px rgba(26,107,90,0.3)",
                zIndex: 1,
              }}>
                {item.step}
              </div>
              ...
              <div style={{
                ...
                borderRadius: "16px",
                padding: "24px 20px",
                boxShadow: "0 4px 24px rgba(20,70,60,0.06), inset 0 1px 0 rgba(255,255,255,0.8)",
              }}>
                ...
                <h3 style={{ fontSize: "1.1rem", fontWeight: 700, color: "#2C3E38", marginBottom: "8px" }}>
                  {item.title}
                </h3>
      ...
      <section style={{ padding: "0 20px 50px" }}>
        <div style={{
          ...
          <h3 style={{ fontSize: "1.35rem", fontWeight: 700, color: "#1A6B5A", marginBottom: "14px", fontFamily: "'Playfair Display', Georgia, serif" }}>
      ...
      <section style={{ padding: "0 20px 50px" }}>
        <h2 style={{
          fontSize: "1.5rem", fontWeight: 700, color: "#1A6B5A",
          textAlign: "center", marginBottom: "12px",
          fontFamily: "'Playfair Display', Georgia, serif",
        }}>
      ...
      <section style={{ padding: "0 20px 50px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {testimonials.map((item, i) => (
            ...
            >
              <div style={{
                fontSize: "2.5rem", lineHeight: 1, color: "rgba(26,107,90,0.12)",
                fontFamily: "Georgia, serif", marginBottom: "-8px",
              }}>&ldquo;</div>
              <p style={{ fontSize: "1.02rem", color: "#2C3E38", lineHeight: 1.65, marginBottom: "14px" }}>
                {item.quote}
              </p>
      ...
      <section style={{ padding: "0 20px 50px" }}>
        <div style={{
          padding: "28px 24px", borderLeft: "4px solid #1A6B5A",
          background: "rgba(26,107,90,0.03)", borderRadius: "0 14px 14px 0",
        }}>
          <p style={{
            fontSize: "1rem", color: "#4A5D56", lineHeight: 1.75,
            fontStyle: "italic",
          }}>
          ...
          <p style={{ fontSize: "0.85rem", color: "#1A6B5A", fontWeight: 700, marginTop: "14px" }}>
            &mdash; Jace, Founder
          </p>
        </div>
      </section>
      ...
      <section id="pricing" style={{ padding: "30px 20px 40px" }}>
        ...
        <p style={{
          fontSize: "0.95rem", color: "#7A8E88", textAlign: "center", marginBottom: "4px",
        }}>
          Free to start because we know what it&apos;s like searching for research with zero budget.
        </p>
        <p style={{
          fontSize: "0.9rem", color: "#4A5D56", textAlign: "center", marginBottom: "8px",
        }}>
        ...
        <div style={{ textAlign: "center", marginTop: "36px" }}>
          <p style={{ fontSize: "0.95rem", color: "#7A8E88", marginBottom: "14px" }}>
      ...
      <footer style={{
        ...
        <span style={{ fontSize: "0.9rem", color: "#7A8E88", fontWeight: 600, display: "block", marginBottom: "14px" }}>Research Match</span>
        <div style={{ display: "flex", justifyContent: "center", gap: "24px", flexWrap: "wrap" }}>
          <Link href="/app" style={{ fontSize: "0.85rem", color: "#7A8E88", textDecoration: "none" }}>Tool</Link>
          <Link href="/blog" style={{ fontSize: "0.85rem", color: "#7A8E88", textDecoration: "none" }}>Blog</Link>
          <a href="#pricing" style={{ fontSize: "0.85rem", color: "#7A8E88", textDecoration: "none" }}>Pricing</a>
          <Link href="/feedback" style={{ fontSize: "0.85rem", color: "#7A8E88", textDecoration: "none" }}>Feedback</Link>
        </div>
      </footer>
      ...
      {waitlistTier && (
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: "24px",
            boxShadow: "0 32px 80px rgba(20,70,60,0.12)",
            padding: "36px 28px", maxWidth: "380px", width: "100%",
          }} onClick={(e) => e.stopPropagation()}>
            {waitlistDone ? (
              <div style={{ textAlign: "center" }}>
                <p style={{ fontSize: "2.5rem", marginBottom: "16px" }}>{"\u{1F389}"}</p>
                <h3 style={{ fontSize: "1.3rem", fontWeight: 700, color: "#1A6B5A", marginBottom: "10px" }}>
                  You&apos;re on the list!
                </h3>
              ...
              <>
                ...
                <p style={{ fontSize: "0.9rem", color: "#7A8E88", marginBottom: "20px", lineHeight: 1.6 }}>
