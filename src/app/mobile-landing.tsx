  ...
  return (
    <div style={{ minHeight: "100vh", position: "relative", overflowX: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "100%", pointerEvents: "none", zIndex: -1, overflow: "hidden", maxWidth: "100vw" }}>
        <div ref={(el) => { splotchRefs.current[0] = el; }} style={{ position: "absolute", top: "5%", right: "-10%", width: 160, height: 160, borderRadius: "50%", background: "radial-gradient(ellipse at 35% 40%, rgba(45, 90, 61,0.08) 0%, transparent 65%)", filter: "blur(100px)", willChange: "transform", opacity: 0.5 }} />
        <div ref={(el) => { splotchRefs.current[1] = el; }} style={{ position: "absolute", top: "25%", left: "-5%", width: 180, height: 180, borderRadius: "50%", background: "radial-gradient(ellipse at 60% 30%, rgba(45, 90, 61,0.1) 0%, transparent 65%)", filter: "blur(100px)", willChange: "transform", opacity: 0.5 }} />
        <div ref={(el) => { splotchRefs.current[2] = el; }} style={{ position: "absolute", top: "45%", right: "5%", width: 140, height: 140, borderRadius: "50%", background: "radial-gradient(ellipse at 40% 60%, rgba(45, 90, 61,0.08) 0%, transparent 65%)", filter: "blur(100px)", willChange: "transform", opacity: 0.5 }} />
        <div ref={(el) => { splotchRefs.current[3] = el; }} style={{ position: "absolute", top: "60%", left: "10%", width: 200, height: 200, borderRadius: "50%", background: "radial-gradient(ellipse at 50% 50%, rgba(45, 90, 61,0.06) 0%, transparent 65%)", filter: "blur(120px)", willChange: "transform", opacity: 0.5 }} />
        <div ref={(el) => { splotchRefs.current[4] = el; }} style={{ position: "absolute", top: "78%", right: "15%", width: 150, height: 150, borderRadius: "50%", background: "radial-gradient(ellipse at 55% 40%, rgba(45, 90, 61,0.07) 0%, transparent 65%)", filter: "blur(100px)", willChange: "transform", opacity: 0.5 }} />
        <div ref={(el) => { splotchRefs.current[5] = el; }} style={{ position: "absolute", top: "92%", left: "30%", width: 180, height: 180, borderRadius: "50%", background: "radial-gradient(ellipse at 45% 55%, rgba(61, 120, 80,0.07) 0%, transparent 65%)", filter: "blur(100px)", willChange: "transform", opacity: 0.5 }} />
      </div>
