  ...
  return (
    <div style={{ minHeight: "100vh", position: "relative", overflowX: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "100%", pointerEvents: "none", zIndex: -1, overflow: "hidden", maxWidth: "100vw" }}>
        <div ref={(el) => { splotchRefs.current[0] = el; }} style={{ position: "absolute", top: "5%", right: "-10%", width: 160, height: 160, borderRadius: "50%", background: "radial-gradient(ellipse at 35% 40%, rgba(61,122,94,0.35) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
        <div ref={(el) => { splotchRefs.current[1] = el; }} style={{ position: "absolute", top: "25%", left: "-5%", width: 180, height: 180, borderRadius: "50%", background: "radial-gradient(ellipse at 60% 30%, rgba(168,196,178,0.5) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
        <div ref={(el) => { splotchRefs.current[2] = el; }} style={{ position: "absolute", top: "45%", right: "5%", width: 140, height: 140, borderRadius: "50%", background: "radial-gradient(ellipse at 40% 60%, rgba(184,216,196,0.45) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
        ...
        <div ref={(el) => { splotchRefs.current[4] = el; }} style={{ position: "absolute", top: "78%", right: "15%", width: 150, height: 150, borderRadius: "50%", background: "radial-gradient(ellipse at 55% 40%, rgba(28,122,86,0.25) 0%, transparent 70%)", filter: "blur(50px)", willChange: "transform" }} />
      ...
      <nav style={{
        ...
        <span style={{ fontSize: "1.1rem", fontWeight: 800, color: "#1C7A56", letterSpacing: "-0.02em", whiteSpace: "nowrap" }}>
          Research Match
        </span>
        <Link href="/app" style={{
            ...
            >
              ...
              {i < steps.length - 1 && (
                <div className="mobile-timeline-line" style={{
                  ...
                  bottom: "0",
                  width: "2px",
                  background: "linear-gradient(to bottom, #A8C4B2, rgba(168,196,178,0.2))",
                }} />
              )}
              {/* Step circle */}
              <div style={{
                ...
                fontWeight: 700,
                color: "#F5F0E6",
                boxShadow: "0 2px 8px rgba(28,122,86,0.3)",
                zIndex: 1,
              }}>
                {item.step}
              </div>
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: "1.1rem", fontWeight: 700, color: "#2C3E34", marginBottom: "8px" }}>
                  {item.title}
                </h3>
      ...
      <section style={{ padding: "0 20px 50px" }}>
        <div style={{
          ...
          <h3 style={{ fontSize: "1.35rem", fontWeight: 700, color: "#1C7A56", marginBottom: "14px", fontFamily: "'Playfair Display', Georgia, serif" }}>
      ...
      <section style={{ padding: "0 20px 50px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {testimonials.map((item, i) => (
            ...
            >
              <div style={{
                fontSize: "2.5rem", lineHeight: 1, color: "rgba(28,122,86,0.12)",
                fontFamily: "Georgia, serif", marginBottom: "-8px",
              }}>&ldquo;</div>
              <p style={{ fontSize: "1.02rem", color: "#2C3E34", lineHeight: 1.65, marginBottom: "14px" }}>
                {item.quote}
              </p>
      ...
      <section style={{ padding: "0 20px 50px" }}>
        <div style={{
          ...
          <p style={{
            fontSize: "1rem", color: "#4A5D50", lineHeight: 1.75,
            fontStyle: "italic",
          }}>
      ...
      <section id="pricing" style={{ padding: "30px 20px 40px" }}>
        ...
        <p style={{
          fontSize: "0.95rem", color: "#7A8E80", textAlign: "center", marginBottom: "4px",
        }}>
          Free to start because we know what it&apos;s like searching for research with zero budget.
        </p>
        <p style={{
          fontSize: "0.9rem", color: "#4A5D50", textAlign: "center", marginBottom: "8px",
        }}>
        ...
        <div style={{ textAlign: "center", marginTop: "36px" }}>
          <p style={{ fontSize: "0.95rem", color: "#7A8E80", marginBottom: "14px" }}>
      ...
      <footer style={{
        ...
        <span style={{ fontSize: "0.9rem", color: "#7A8E80", fontWeight: 600, display: "block", marginBottom: "14px" }}>Research Match</span>
        <div style={{ display: "flex", justifyContent: "center", gap: "24px", flexWrap: "wrap" }}>
          <Link href="/app" style={{ fontSize: "0.85rem", color: "#7A8E80", textDecoration: "none" }}>Tool</Link>
          <Link href="/blog" style={{ fontSize: "0.85rem", color: "#7A8E80", textDecoration: "none" }}>Blog</Link>
          <a href="#pricing" style={{ fontSize: "0.85rem", color: "#7A8E80", textDecoration: "none" }}>Pricing</a>
          ...
          <div style={{
            ...
            {waitlistDone ? (
              <div style={{ textAlign: "center" }}>
                ...
                <h3 style={{ fontSize: "1.3rem", fontWeight: 700, color: "#1C7A56", marginBottom: "10px" }}>
                  You&apos;re on the list!
                </h3>
              ...
              <>
                ...
                <p style={{ fontSize: "0.9rem", color: "#7A8E80", marginBottom: "20px", lineHeight: 1.6 }}>
