    ...
    <div style={{ minHeight: "100vh", padding: "40px 20px" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <h1 style={{
          ...
          color: "#1C7A56", marginBottom: "12px", letterSpacing: "-0.02em",
        }}>
          Blog
        </h1>
        <p style={{ fontSize: "1.1rem", color: "#7A8E80", marginBottom: "48px", lineHeight: 1.6 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
          {posts.map((post) => (
            ...
            >
              <h2 style={{ fontSize: "1.2rem", fontWeight: 700, color: "#1C7A56", marginBottom: "8px", lineHeight: 1.4 }}>
                {post.title}
              </h2>
              <p style={{ fontSize: "0.9rem", color: "#7A8E80", lineHeight: 1.6 }}>
                {post.description}
              </p>
            </Link>
          ))}
        ...
        <div style={{ marginTop: "60px", padding: "32px", textAlign: "center", borderTop: "1px solid rgba(168,196,178,0.3)" }}>
